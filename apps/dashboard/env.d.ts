...
export type CoercedEnvSchema = {
    /**
     * **NEXT_PUBLIC_API_URL**  
     * URL points to the published host and port for the Service application (localhost:8083)  
     * when using the compose, ensure not to include trailing slash  
    ...
    /**
     * **DISABLE_AUTH**  
     * Disables/enables next auth during development, this gets short circuited when NEXT_ENV === production though  
     ...
     * Disables/enables next auth for client side auth state  
     * ![icon](data:image/svg+xml;utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2220%22%20height%3D%2220%22%20viewBox%3D%220%200%2032%2032%22%3E%3Cpath%20fill%3D%22%23808080%22%20d%3D%22M23%2023a7%207%200%201%201%207-7a7.01%207.01%200%200%201-7%207m0-12a5%205%200%201%200%205%205a5.006%205.006%200%200%200-5-5%22%2F%3E%3Ccircle%20cx%3D%229%22%20cy%3D%2216%22%20r%3D%227%22%20fill%3D%22%23808080%22%2F%3E%3C%2Fsvg%3E)  
     */
    NEXT_PUBLIC_DISABLE_AUTH: boolean;
};

type _CoercedEnvSchema_105c26d6 = CoercedEnvSchema;

declare module "varlock/env" {
    export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_105c26d6> {}
    export interface PublicTypedEnvSchema extends Readonly<
        Pick<
            _CoercedEnvSchema_105c26d6,
            "NEXT_PUBLIC_API_URL" | "DISABLE_AUTH" | "NEXT_PUBLIC_DISABLE_AUTH"
        >
    > {}
}
...
type _EnvSchemaAsStrings_105c26d6 = EnvSchemaAsStrings;
declare global {
    // add types for global import.meta.env
    interface ImportMetaEnv extends _EnvSchemaAsStrings_105c26d6 {}
    ...
    namespace NodeJS {
        interface ProcessEnv extends _EnvSchemaAsStrings_105c26d6 {}
    }
}
