...
type _CoercedEnvSchema_922db6b2 = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_922db6b2> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_922db6b2, 'NEXT_PUBLIC_API_URL' | 'DISABLE_AUTH'>> {}
}
...
type _EnvSchemaAsStrings_922db6b2 = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_922db6b2 {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_922db6b2 {}
  }
}