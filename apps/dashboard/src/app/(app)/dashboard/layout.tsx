...
import { ToolbarProvider, useToolbar } from "@/features/dashboard/components/toolbar/toolbarProvider";
...
function DashboardLayoutInner({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return (
    <div className="flex flex-col flex-1 h-full w-full">
      ...
      />
      <div className="flex-1 overflow-y-auto overflow-x-hidden flex flex-col relative">{children}</div>
    </div>
  );
}
