        ...
        <section className={className}>
            ...
            <div className="space-y-3">
                {servicesAvailable.map((service) => (
                    <label
                        key={service.id}
                        className="flex items-center gap-3 w-full p-4 bg-card rounded-lg border border-border hover:bg-muted/30 transition-all cursor-pointer focus-within:ring-2 focus-within:ring-primary focus-within:ring-offset-2"
                    >
                        <input
                            type="checkbox"
