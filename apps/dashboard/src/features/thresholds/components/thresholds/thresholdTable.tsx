    ...
    return(
        <TooltipProvider>
            <Tooltip>
                ...
                <TooltipContent> <p className = "max-w-xs break-all"> {tooltipText ?? text} </p></TooltipContent>
            </Tooltip>
        </TooltipProvider>
    );
}
    ...
    return [
...

        {
            ...
            cell: ({ row }) => {
                ...
                return (
                    <Truncation text = {visibleCondition} tooltipText = {tooltip} className = {
                        mutedThreshold ? "text-muted-foreground" : "text-foreground"}/>
                );
            },
        },
