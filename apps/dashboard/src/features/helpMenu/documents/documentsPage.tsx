...
export default function HelpCenter({
    name, description, breadcrumb, icon : Icons, instructions
        ...
        <div className = "min-h-screen bg-background">
            <div className = "border-b border-border px-8 py-5">
                ...
                <Breadcrumb>
                    <BreadcrumbList>
                        <BreadcrumbItem>
                            <BreadcrumbLink href = "/dashboard" className = "text-[13px] text-muted-foreground"> Dashboard </BreadcrumbLink>
                        </BreadcrumbItem>
                        ...
                        <BreadcrumbItem>
                            <BreadcrumbPage className = "text-[13px] font-medium text-foreground"> {breadcrumb} </BreadcrumbPage>
                        </BreadcrumbItem>
            ...
            <div className = "mx-auto max-w-[720px] px-6 pb-20 pt-12">
                <div className = "mb-10 flex items-center gap-4">
                    <div className = "flex h-12 w-12 items-center justify-center rounded-lg bg-muted text-primary"> <Icons className = "h-6 w-6" strokeWidth = {1.75}/> </div>
                            ...
                            <CardContent className = "p-5">
                                <div className = "flex items-start gap-4">
                                    ...
                                    <div className = "flex flex-col items-center">
                                        <span className = "flex h-8 w-8 items-center justify-center rounded-full bg-muted text-[12px] font-medium text-primary"> {i+1} </span>
                                    ...
                                    <div className = "flex-1">
                                        ...
                                        <ul className = "mt-3 flex flex-col gap-2">
                                            {instruction.details.map((detail) => (
                                                <li key = {detail} className = "flex items-stat gap-2 text-[12.5px] text-muted-foreground">
