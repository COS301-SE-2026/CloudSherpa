...
const forFeatureItems = [
...

    {
        ...
        benefits: [
            ...
            { label: "Notify your way", detail: "Email or SMS, choose what works for your team." },
        ],
    },
            ...
            >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 18, marginBottom: 24 }}>
                    ...
                    <div>
                        ...
                        <p style={{ fontSize: 14, color: "#CBD5E1", opacity: 0.55 }}>
                            {card.subHeading}
                        </p>
                    </div>
                </div>
                            ...
                            >
                                ...
                                <div
                                    style={{
                                        ...
                                        borderRadius: "50%",
                                        background:
                                            "linear-gradient(135deg, #2F2FE4 0%, #162E93 100%)",
                                        flexShrink: 0,
                                    }}
                                />
                ...
                {activeCardIndex === null ? (
                    ...
                    >
                        <h2 className="text-4xl font-bold tracking-tight text-center mb-12">
                            <span className="bg-gradient-to-r from-[#2F2FE4] to-[#162E93] bg-clip-text text-transparent">
                                Powerful.
                            </span>{" "}
                            ...
                            {forFeatureItems.map((forFeature, forItem) => (
                                <button
                                    ...
                                    style={{
                                        ...
                                        backgroundOrigin: "border-box",
                                        backgroundClip: "padding-box, border-box",
                                        animationName: showingFeatureCards ? "fadeSlideUp" : "none",
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[13px] text-[#CBD5E1] m-0 opacity-60">
                                            {forFeature.subHeading}
                                        </p>
                                    </div>
                                </button>
                            ))}
                    ...
                    <DetailedFeatures card={forFeatureItems[activeCardIndex]} onBack={handleBack} />
                )}
            </section>
        );
    }
