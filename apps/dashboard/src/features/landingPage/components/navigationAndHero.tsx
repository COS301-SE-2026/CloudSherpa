...
export function HeroAndNavBar({ scrolled }: Readonly<PropsForNavBarHero>) {
    ...
    return (
        <>
            <nav
                className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "backdrop-blur-xl bg-background/92" : "bg-transparent"} border-b ${scrolled ? "border-border" : "border-transparent"}`}
            >
            ...
            <section className="relative min-h-screen flex flex-col items-center justify-center text-center overflow-hidden pt-16 pb-8">
                <div className="relative max-w-4xl mx-auto px-6 flex flex-col items-center justify-center py-10">
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-semibold leading-[1.04] tracking-tight mb-2 text-foreground text-center">
                        {" "}
                        Cloud Costs{" "}
                    </h1>

                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-semibold leading-[1.04] tracking-tight mb-8 text-primary text-center">
                        {" "}
                        Eliminated{" "}
                    </h1>

                    <p className="text-lg md:text-xl max-w-xl mx-auto mb-10 leading-relaxed text-muted-foreground text-center">
                        {" "}
                        AI powered optimization for multi-cloud environments. One unified picture
                    ...
                    >
                        {" "}
                        Discover more <ChevronDown size={16} className="animate-bounce" />{" "}
                    </a>
                </div>
            </section>
        </>
