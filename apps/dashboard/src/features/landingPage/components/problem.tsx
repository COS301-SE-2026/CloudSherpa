                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 leading-snug">
                            {" "}
                            Multiple clouds. Multiple bills.{" "}
                    ...
                    <div className="flex flex-col gap-3">
                        {[
                            "Delayed cost visibility & bill shock",
                            "Overprovisioning due to risk aversion",
                            "Inconsistent multi-cloud cost normalization",
                            "Limited FinOps capabilites",
                        ].map((forProblems) => (
