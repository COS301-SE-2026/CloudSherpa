...
const FORSTEPNUM: ForStepNum[] = [
    {
        number: "1",
        name: "Connect your clouds",
        description:
            "Link your cloud accounts with your credentials in a guided wizard and CloudSherpa will handle the rest",
    },
                    ...
                    {FORSTEPNUM.map((forSteps) => (
                        <Card key={forSteps.number} className="relative h-full">
                            <CardContent className="p-6 flex flex-col items-center justify-center text-center">
                                <div className="w-12 h-12 rounded-xl flex items-center justify-center text-lg font-bold mb-5 bg-primary text-primary-foreground">
                                    {" "}
                                    {forSteps.number}{" "}
                                </div>
