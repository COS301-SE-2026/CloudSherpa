...
import {useState} from "react";import {WebhookEvent} from "@/features/webhooks/types";
...
export const ExampleForPayload = ({event} : PropsForPayload) => {
    ...
    const headers : Record<string, string> = event.requestHeaders ?? {
        ...
        "Demo signing key": "whsec_AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8= (not an HTTP header)",
    };
