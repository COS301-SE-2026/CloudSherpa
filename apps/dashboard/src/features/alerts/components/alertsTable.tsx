...
export function AlertsTable({ alerts, acknowledge, dismiss }: Readonly<PropsForAlertsTable>) {
        ...
        () => [
                        ...
                        <span
                            className={
                                inactive
                                    ...
                                    : SEVERITY_COLOURS[access.severity]
                            }
                        >
                            {" "}
                            {access.severity}{" "}
...

            {
                ...
                cell: ({ row }) => {
                    ...
                    return (
                        <span className="text-foreground"> {forPayload.z_score.toFixed(2)} </span>
                    );
                },
            },
                ...
                cell: ({ row }) => {
                    ...
                    return (
                        <span className="text-foreground">
                            {" "}
                            {typeof forValue === "number" ? forValue.toFixed(2) : "-"}{" "}
                        </span>
                    );
                },
            },
                ...
                cell: ({ row }) => {
                    ...
                    return (
                        <span className="text-muted-foreground">
                            {" "}
                            {forPayload.average_value.toFixed(2)} +-{" "}
                            {forPayload.standard_deviation.toFixed(2)}{" "}
                        </span>
                    );
                },
            },
                    ...
                    return (
                        <div className="flex items-center gap-1">
                            <Button
                                ...
                                disabled={!active}
                                onClick={() => acknowledge(access.alertId)}
                            >
                                {" "}
                            ...
                            <Button
                                ...
                                disabled={!active}
                                onClick={() => dismiss(access.alertId)}
                            >
                                {" "}
                                <X className="h-4 w-4" />{" "}
                            </Button>
