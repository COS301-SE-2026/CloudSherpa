...
export function GaugeChart({ resourceId, metricType, metricFetchLoad = false }: Readonly<GaugeChartProps>) {
  ...
  useEffect(() => {
    ...
    // Custom handling for dashboard layout widget shifts (e.g., Gridstack adjustments)
