  ...
  return (
    <Popover
      ...
      <PopoverTrigger asChild>
        <Button
          variant="outline"
          className="group w-72 justify-between text-left font-normal bg-card border-border hover:bg-hover transition-button">
          <div className="flex flex-row items-center overflow-hidden">
            <LayoutDashboard className="mr-2 h-4 w-4 text-foreground-secondary shrink-0" />
            <span className="truncate text-foreground">{selectedDashboard?.label || "Select Dashboard"}</span>
          </div>
      ...
      <PopoverContent className="p-0 w-72 bg-popover border-border-strong shadow-xl" align="start">
        {view === "list" ? (
          <div className="flex flex-col p-1">
            ...
            <Button
              variant="ghost"
              className="justify-start font-medium text-accent hover:bg-hover transition-button group/btn"
