package com.cloudsherpa.ingestion.provider.azure.services.aks;
...
@Component
public class AzureKubernetesScanner implements AzureResourceScanner {
  ...
  public List<String> getResourceTypes() {
    return List.of("microsoft.containerservice/managedclusters");
  }
