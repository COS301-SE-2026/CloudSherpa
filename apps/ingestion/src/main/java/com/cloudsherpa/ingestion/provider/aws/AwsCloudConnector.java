...
public class AwsCloudConnector implements CloudConnector, UsageCapable, BillingCapable {
    ...
    private List<UsageRecordModel> processServiceScope(
        ...
        MutableDouble serviceClusterState = new MutableDouble(50.0 + new Random(accountSeed).nextGaussian() * 10);
    ...
    private List<UsageRecordModel> processTimestamp(
        ...
        double clusterFactor = updateClusterFactor(rng, seasonalFactors.getBurst(), serviceClusterState);
