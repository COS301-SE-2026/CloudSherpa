package com.cloudsherpa.ingestion.provider.azure.services.acr;
...
@Component
public class AzureContainerRegistryScanner implements AzureResourceScanner {
  ...
  public List<String> getResourceTypes() {
    return List.of("microsoft.containerregistry/registries");
  }
