package com.cloudsherpa.ingestion.provider.azure.services.postgresql;
...
@Component
public class AzurePostgreSqlScanner implements AzureResourceScanner {
  ...
  public List<String> getResourceTypes() {
    return List.of("microsoft.dbforpostgresql/flexibleservers");
  }
