...
type _CoercedEnvSchema_85d2e3bc = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_85d2e3bc> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_85d2e3bc, 'POSTGRES_HOST' | 'POSTGRES_PORT' | 'POSTGRES_DB' | 'POSTGRES_USER' | 'SPRING_PROFILES_ACTIVE'>> {}
}
...
type _EnvSchemaAsStrings_85d2e3bc = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_85d2e3bc {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_85d2e3bc {}
  }
}