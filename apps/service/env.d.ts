...
type _CoercedEnvSchema_2a70b5d7 = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_2a70b5d7> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_2a70b5d7, 'POSTGRES_HOST' | 'POSTGRES_PORT' | 'POSTGRES_DB' | 'POSTGRES_USER' | 'AUTH_JWT_EXP_MINUTES' | 'SPRING_PROFILES_ACTIVE' | 'DASHBOARD_HOST' | 'INGESTION_BASE_URL'>> {}
}
...
type _EnvSchemaAsStrings_2a70b5d7 = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_2a70b5d7 {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_2a70b5d7 {}
  }
}