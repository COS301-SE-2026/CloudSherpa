...
public class AnalyticsPersistenceService 
{
    ...
    @Transactional
    public void recordMetric(UUID environmentId, String resourceId, String serviceCategory, BigDecimal usageAmount, String usageUnit, BigDecimal costAmount) 
    {
        EnvironmentReference environment = environmentRepo.getReferenceById(environmentId);
        NormalizedMetrics newMetric = new NormalizedMetrics(OffsetDateTime.now(), environment, resourceId, serviceCategory, usageAmount, usageUnit, costAmount);
