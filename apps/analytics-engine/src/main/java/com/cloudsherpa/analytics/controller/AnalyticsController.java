package com.cloudsherpa.analytics.controller;

import com.cloudsherpa.analytics.entity.NormalizedMetrics;
import com.cloudsherpa.analytics.service.AnalyticsPersistenceService;
...
public class AnalyticsController 
{
    ...
    // POST request to inserta record into the database
    // Insert into the AnalyticsDB
    @PostMapping("/metrics/record") // URL: /api/analytics/metrics/record
    public String recordMetric(@RequestParam UUID environmentId, @RequestParam String resourceId,
        @RequestParam String serviceCategory, @RequestParam BigDecimal usageAmount,
        @RequestParam String usageUnit, @RequestParam BigDecimal costAmount, @RequestParam(defaultValue = "ZAR") String currency) 
    {
        
        analyticsPersistenceService.recordMetric(environmentId, resourceId, serviceCategory, usageAmount, usageUnit, costAmount, currency);
